...
#' 
#' # Calculation of community weighted mean of species functional traits using dataset aravo from ade4 library
#' data (aravo, package = 'ade4')
#' cwm <- wm (sitspe = aravo$spe, speatt = aravo$traits)
#' 
#' summary (cwm) # brief summary
#' 
